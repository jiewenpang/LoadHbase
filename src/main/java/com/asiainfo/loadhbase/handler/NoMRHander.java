...
public class NoMRHander extends BaseHandler {
	...
	public void run() throws Exception { // 单进程处理模式
		...
		logger.info("file list:" + fileInfoList.size() + ",all task finish,total time:" + (endtime - sttime) / 1000 + "s,quit...");
	}


public static class NoMRClass {
	static final Log LOG = LogFactory.getLog(NoMRClass.class);
	...
	public void setup(String recordClassName, String regions, String family, String columns,
			String filterregion, String ischgport) throws IOException, InterruptedException {
